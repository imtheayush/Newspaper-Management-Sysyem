      ...
      function drawChart() {
        ...
        //  ['Post', 10],
          <?php
            ...
            $element_count = [$post_count,$post_published_count,$post_draft_count,$post_draft_count,$comment_counts,$unapproved_comments_count,$user_count,$subscriber_count,$category_count];
            for($i = 0;$i < 8;$i++)
            {
